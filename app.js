...
⚡ MODO FORZADO: TAREA
Josep Maria ha activado el modo TAREA antes de este mensaje. El contenido que te ha enviado es una tarea — NO lo cuestiones, NO preguntes si es tarea o idea, simplemente créala con crear_tasca. Lo único que puedes preguntar (y solo si NO está claro) es: la prioridad, si tiene fecha límite, o si es profesional/personal. Si todo está claro o es deducible, créala sin preguntar nada y confirma brevemente.`;
  } else if (mode === 'idea') {
    modeInstruction = `
